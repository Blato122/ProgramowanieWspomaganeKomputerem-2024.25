...
def create_vehicle(genes):
    ...
    # If 'is_red' is True, set the chassis material to red and make the car faster
    if is_red:
        ...
        # Reduce mass to increase speed
        chassis.rigid_body.mass *= 1.2
    ...
    for pos in wheel_positions:
        ...
        wheel.rigid_body.friction = 0.5 + 1/(1-wheel_thickness)
